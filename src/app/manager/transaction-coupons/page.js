...
export default function ListTransactionCoupon() {
    ...
    const fetchCoupons = useCallback(async () => {
        ...
        try {
            ...
            if (res.ok) {
                ...
                const couponRes = await fetch(`${process.env.NEXT_PUBLIC_API_TRANSACTION_COUPON_BASE_URL}/supermarket/${supermarketId}`, {
                    method: 'GET',
                    headers: {
                        'Content-Type': 'application/json',
                        'Authorization': `Bearer ${token}`,
    ...
    const handleDelete = async (couponId) => {
        try {
            const res = await fetch(`${process.env.NEXT_PUBLIC_API_TRANSACTION_COUPON_BASE_URL}/delete`, {
                method: 'DELETE',
                headers: {
                    'Content-Type': 'application/json',
